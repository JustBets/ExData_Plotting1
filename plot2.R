...
##Launch png graphics device, call plot, close the graphics device
png(file = "plot2.png", width = 480, height = 480)
plot(smallData$DateTime, smallData$Global_active_power, type="l", col="black", ylab="Global Active Power (kilowatts)", xlab='')
dev.off()
